    ...
    if(int(info['ram']) < 2):
        class Application:
            def __init__(self, master=None):
                ...
                self.msg = Label(
                    self.widget1, text="ram insuficiente para o sistemacolibri")
    ...
    if(int(info['ram']) < 4):
        class Application:
            def __init__(self, master=None):
                ...
                self.widget1.pack(side=LEFT)
                self.msg = Label(
                    self.widget1, text="memoria ram fora do recomentdado")
                self.msg["font"] = ("Verdana", "10", "italic", "bold")
                self.msg.pack()
                self.sair = Button(self.widget1)
                self.sair["text"] = "OK"
    ...
    if (info['platform-release'] == "10"):
        ...
        class Application:
            def __init__(self, master=None):
                ...
                self.widget1.pack(side=LEFT)
                self.msg = Label(
                    self.widget1, text="sistema operacional incompativel com colibri")
                self.msg["font"] = ("Verdana", "10", "italic", "bold")
                self.msg.pack()
                self.sair = Button(self.widget1)
                self.sair["text"] = "OK"
